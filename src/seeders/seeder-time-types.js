...
module.exports = {
  async up(queryInterface, Sequelize) {
    return queryInterface.bulkInsert("TimeTypes", [
      {
        id: Constants.TimeType.T1_08_09,
      ...
      {
        id: Constants.TimeType.T2_09_10,
      ...
      {
        id: Constants.TimeType.T3_10_11,
      ...
      {
        id: Constants.TimeType.T4_11_12,
      ...
      {
        id: Constants.TimeType.T5_13_14,
      ...
      {
        id: Constants.TimeType.T6_14_15,
      ...
      {
        id: Constants.TimeType.T7_15_16,
      ...
      {
        id: Constants.TimeType.T8_16_17,
